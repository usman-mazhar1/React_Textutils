...
<div className="container" style={{color : props.mode == 'light'?'black':'white', backgroundColor : props.mode == 'light'?'white':'#042743'} }>
    ...
    <div className="accordion-item">
        ...
        <button className="accordion-button" style={{color : props.mode == 'light'?'black':'white', backgroundColor : props.mode == 'light'?'white':'#042743'} } type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            Accordion Item #1
        </button>
        </h2>
